...
//get all items related to particular order
...
exports.update = (req, res) => {
   ...
   // Find item and update it with the request body
    // Order.findByIdAndUpdate([req.params.orderId,req.params.itemId], {
    //    Qty: req.body.Qty
    ...
    //     });
    // });
     Order.findOneAndUpdate({_id: [req.params.orderId,req.params.itemId]}, updatedData, function(err, item) {
